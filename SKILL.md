---
name: scanpen-api-test
description: ScanPen 串口 API 验证和压测工作流。Use when Codex needs to validate ScanPen/scanpen devices over AP/CP serial ports, run version/translation/TTS checks, execute configurable pressure tests with scanInfo.json, analyze result logs, or reuse the bundled ScanPen API test scripts, configs, and corpus.
---
